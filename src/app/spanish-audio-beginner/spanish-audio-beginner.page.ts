...
@Component({
  selector: 'app-spanish-audio-beginner',
  templateUrl: './spanish-audio-beginner.page.html',
  styleUrls: ['./spanish-audio-beginner.page.css'],
})
export class SpanishAudioBeginnerPage implements OnInit {
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'Spanish/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'Spanish/Beginner Lessons/Reading Lessons');
