...
@Component({
  selector: 'app-swa-read-beginner',
  templateUrl: './swa-read-beginner.page.html',
  styleUrls: ['./swa-read-beginner.page.css'],
})
export class SwaReadBeginnerPage implements OnInit {
  pdfs: any[] = [];
  error: string = '';
  ...
  async loadReadingMaterials() {
    ...
    try {
      const dataRef = ref(db, 'Swahili/Beginner Lessons/Reading Lessons');
      console.log('Fetching data from:', 'Swahili/Beginner Lessons/Reading Lessons');
