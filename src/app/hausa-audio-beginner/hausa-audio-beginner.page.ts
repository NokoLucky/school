...
@Component({
  selector: 'app-hausa-audio-beginner',
  templateUrl: './hausa-audio-beginner.page.html',
...
resetZoom() {
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'Hausa/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'Hausa/Beginner Lessons/Reading Lessons');
