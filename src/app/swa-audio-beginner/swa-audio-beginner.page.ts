...
@Component({
  selector: 'app-swa-audio-beginner',
  templateUrl: './swa-audio-beginner.page.html',
  styleUrls: ['./swa-audio-beginner.page.css'],
})
export class SwaAudioBeginnerPage implements OnInit {
  playlist: Track[] = [];
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'Swahili/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'Swahili/Beginner Lessons/Reading Lessons');
