...
@Component({
  selector: 'app-hausa-read-beginner',
  templateUrl: './hausa-read-beginner.page.html',
  styleUrls: ['./hausa-read-beginner.page.css'],
})
export class HausaReadBeginnerPage implements OnInit {
...
pdfs: any[] = [];
  ...
  async loadReadingMaterials() {
    ...
    try {
      const dataRef = ref(db, 'Hausa/Beginner Lessons/Reading Lessons');
      console.log('Fetching data from:', 'Hausa/Beginner Lessons/Reading Lessons');
