...
@Component({
  selector: 'app-duala-audio-beginner',
  templateUrl: './duala-audio-beginner.page.html',
  styleUrls: ['./duala-audio-beginner.page.css'],
})
export class DualaAudioBeginnerPage implements OnInit {
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'Duala/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'Duala/Beginner Lessons/Reading Lessons');
