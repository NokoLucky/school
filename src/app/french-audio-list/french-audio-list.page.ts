...
@Component({
  selector: 'app-french-audio-list',
  templateUrl: './french-audio-list.page.html',
  styleUrls: ['./french-audio-list.page.scss'],
})
export class FrenchAudioListPage implements OnInit {
  playlist: Track[] = [];
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'French/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'French/Beginner Lessons/Reading Lessons');
