...
@Component({
  selector: 'app-bassa-audio-beginner',
  templateUrl: './bassa-audio-beginner.page.html',
  styleUrls: ['./bassa-audio-beginner.page.css'],
})
export class BassaAudioBeginnerPage implements OnInit {
  playlist: Track[] = [];
  ...
  async loadAudioAndReadingLessons() {
    ...
    try {
      const audioRef = ref(db, 'Bassa/Beginner Lessons/Audio Lessons');
      const readingRef = ref(db, 'Bassa/Beginner Lessons/Reading Lessons');
